...
public class SolrBasicQuery {
    ...
    public static void main(String[] args) throws IOException, SolrServerException {    //进行Solr数据的查询
        ...
        //将认证的信息传入HttpClient构建对象之中，创建一个Http客户端
        ...
        for(SolrDocument document : results) { //文档迭代输出
            System.out.println("【返回信息】id = "+ document.get("id")+ "、name = " + document.get("solr_s_name")
            + "、catalog = " + document.get("solr_s_catalog"));
        }
        solrClient.close();
